...
\cregex{\input{./quoted_string.tex}}\\
...
Using lookaround:\\
\cregex{\input{./thousandsep_1.tex}}\\
...
\cregex{\input{./time12.tex}}\\

\sectiontitle{Match time (24 hours)}

\cregex{\input{./time24_1.tex}}\\
or\\
\cregex{\input{./time24_2.tex}}\\
...
\cregex{\input{./matchclosetag_lazy.tex}}\\
Using greedy quantifier:
\cregex{\input{./matchclosetag_greedy.tex}}\\
Loop-unrolling with
\regex{normal} = \cregex{[\^{}<]} and
\regex{special} = \cregex{(?!</?B>)<}:\\
\regex{\input{./matchclosetag_lu.tex}}\\
